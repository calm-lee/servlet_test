...
<form method="get" action="/lesson03/quiz02/IU_template.jsp">


			<%
			String title = request.getParameter("title");
			if(title == null){//메인 페이지로 돌아갈 때
			%>
		...
		%>	
		<div class="song-info d-flex mt-3">
			<div class="image">
				<img src=<%=(String)(item.get("thumbnail")) %> width="150px">
			</div>
			
			<div class="introduce ml-3">
				<span style="font-size: 30px; font-weight: bold"><%=(String)(item.get("title")) %></span><br>
				<span style="font-size: 20px;"><%=(String)(item.get("composer")) %></span><br>
				<span style="font-size: 20px;"><%=(String)(item.get("debute")) %></span>
			</div>
